...
class OrderService {
    ...
    create(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const player = yield this.lookupService.findPlayer(playerId);
            ...
            yield this.createTickets(order._id, playerId, orderDTO.registrationCount);
            return order;
        });
    }
    getById(queryParams) {
    ...
    getAll(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return orderList.map((order) => new orderDTO_1.OrderDTO(order).toDetailDTO());
        });
    }
